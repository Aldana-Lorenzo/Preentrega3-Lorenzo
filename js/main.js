...
CATEGORIAS.forEach((categoria) => {
    ...
    // Creo una etiqueta a y le asigno una ruta dinámina con el query params ?id= y como valor, le concateno el id vinculado a la categoria que se está iterando en ese momento
